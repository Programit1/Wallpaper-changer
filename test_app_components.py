...
def test_all():
    ...
    cfg.set("search_query", "test_query")
    assert cfg.get("search_query") == "test_query", "Config test failed"
    ...
    # 4. Cache Manager & LRU Eviction Test
    ...
    print(f"[OK] Win32 Utils checks: Autostart={autostart}")

    # 6. Scheduler Interval Test
